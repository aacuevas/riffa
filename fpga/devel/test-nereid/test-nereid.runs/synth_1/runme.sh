...
HD_PWD='Y:/dev/open-ephys/ONI/riffa/fpga/devel/test-nereid/test-nereid.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log KC705_Gen2x8If128.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source KC705_Gen2x8If128.tcl
