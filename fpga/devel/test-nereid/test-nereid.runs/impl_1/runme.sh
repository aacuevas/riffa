...
HD_PWD='Y:/dev/open-ephys/ONI/riffa/fpga/devel/test-nereid/test-nereid.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log KC705_Gen2x8If128.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source KC705_Gen2x8If128.tcl -notrace
